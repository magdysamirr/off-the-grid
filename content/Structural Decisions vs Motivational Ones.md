...
We've applied this at [[WordReward]] without calling it that. When clients kept requesting last-minute changes, I didn't resolve to "be firmer" or "set better boundaries". We restructured the contract terms to include revision limits and timeline buffers. The decision was made once, in the contract. Not fifty times across fifty interactions. The client can't erode the boundary because the boundary is baked into the system, not my mood on Tuesday.
...
>I think: "I'll use Things 3 to track my tasks, that's my system!"  
